...
class infinitePlaneColliderNode : public MPxLocatorNode
{
public:
    infinitePlaneColliderNode();
    ~infinitePlaneColliderNode() override;
...
class infinitePlaneColliderDrawOverride : public MHWRender::MPxDrawOverride
{
public:
    static MHWRender::MPxDrawOverride* creator(const MObject& obj);

    virtual ~infinitePlaneColliderDrawOverride() override;
...
private:
    explicit infinitePlaneColliderDrawOverride(const MObject& obj);
};

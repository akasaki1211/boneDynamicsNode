...
call :Build 2027 "Autodesk_Maya_2027*_DEVKIT_Windows" v143
call :Build 2026 "Autodesk_Maya_2026*_DEVKIT_Windows" v143
call :Build 2025 "Autodesk_Maya_2025*_DEVKIT_Windows" v143
call :Build 2024 "Autodesk_Maya_2024*_DEVKIT_Windows" v143
...
set "MSVC=%~3"
set "DIRNAME=build_%MAYA_VERSION%"
...
cmake -S "%SOURCE_DIR%" -B "%DIRNAME%" -G "%GENERATOR%" -A x64 -T "%MSVC%"
